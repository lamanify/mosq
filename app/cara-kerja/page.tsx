    ...
    return (
        <div className="bg-black min-h-screen">
            ...
            <main>
                            ...
                            {steps.map((step, index) => (
                                ...
                                >
                                    <div className="lg:w-1/2">
                                        ...
                                        <p className="text-gray-400 mb-6 text-lg leading-relaxed font-sans">{step.description}</p>
                                    ...
                                    <div className="lg:w-1/2 flex items-center justify-center">
                                        <div className="w-full max-w-md h-64 glass-panel rounded-2xl flex items-center justify-center border border-white/10 shadow-lg shadow-gold/5 bg-white/5">
                ...
                {/* Important Notes */}
                <section className="bg-white/5 border-y border-white/5 py-16 sm:py-20 backdrop-blur-md">
                    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            {[
                                ...
                                <div key={i} className={`reveal-on-load stagger-${i + 1} glass-card rounded-xl p-6 border border-white/5 hover:border-gold/30 transition-all font-sans`}>
